...
namespace {
struct qt_meta_tag_ZN10EventModelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10EventModelE = QtMocHelpers::stringData(
    "EventModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10EventModelE[] = {
...
Q_CONSTINIT const QMetaObject EventModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10EventModelE.offsetsAndSizes,
    qt_meta_data_ZN10EventModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10EventModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *EventModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10EventModelE.stringdata0))
